...
def O():F();A(E);A('♦ GIT CONFIG™ ♦');A(E);A('Github: https://github.com/Eduardoiago');A('Developed by Eduardo Iago | Versão: 1.0.0\n');A('O gitConfig é uma ferramenta desenvolvida em python para configurar o git em uma nova máquina.');B(D)
def P():
...
def Q():C.system('git config --list')
def F():C.system('clear'if C.name=='posix'else'cls')
E=27*'⣿⣿'
R='\x1b[3m\n\n            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⣷⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n            ⠀⠀⠀⠀⠀⠀⠀⠀⠐⢿⣿⣿⣿⣿⣦⡀⠀⠀⠀⠀⠀⠀⠀\n            ⠀⠀⠀⠀⠀⢀⣴⣿⣦⡀⠙⠉⠻⣿⣿⣿⣦⡀⠀⠀⠀⠀⠀\n            ⠀⠀⠀⢀⣴⣿⣿⣿⣿⣇⠀⠀⠀⢽⣿⣿⣿⣿⣦⡀⠀⠀⠀\n            ⠀⢀⣴⣿⣿⣿⣿⣿⣿⣿⡇⠀⣦⡀⠙⢿⢿⣿⣿⣿⣦⡀⠀\n            ⣴⣿⣿⣿⣿⣿⣿⣿⣿⣿⡇⠀⣿⣿⡆⠀⠀⠈⢻⣿⣿⣿⣆\n            ⠙⢿⣿⣿⣿⣿⣿⣿⣿⣿⡇⠀⣿⣿⣷⣄⣀⣠⣿⣿⣿⠟⠁\n            ⠀⠀⠙⢿⣿⣿⣿⣿⣿⡿⠃⠀⠻⣿⣿⣿⣿⣿⣿⠟⠁⠀⠀\n            ⠀⠀⠀⠀⠙⢿⣿⣿⣿⣇⠀⠀⠀⣽⣿⣿⣿⠟⠁⠀⠀⠀⠀\n            ⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣷⣶⣾⣿⣿⠟⠁⠀⠀⠀⠀⠀⠀\n            ⠀⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣿⠟⠁⠀⠀⠀⠀⠀⠀⠀⠀\n            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠛⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n\n            ♦ GIT CONFIG™ version 1.0 ♦\n\x1b[m'
def G():
	while True:
		F();A(E);A(R);A(E);A('\n1. Configurar nome de usuário global');A('2. Configurar endereço de e-mail global');A('3. Configurar editor padrão');A('4. Configurar branch principal');A('5. Configurar nome de usuário local (por repositório)');A('6. Configurar endereço de e-mail local (por repositório)');A('7. Gerar chave SSH (Ed25519 ou rsa 4096)');A('9. Listar as configurações do git');A('x. Sair');C=B('\nDigite o número da opção desejada: ')
		if C=='1':I()
		elif C=='2':J()
		elif C=='3':K()
		elif C=='4':L()
